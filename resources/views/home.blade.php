...
<div class="cover-image short-cover">
  <div class="col-md-offset-2 col-md-8 col-sm-12">
    ...
    <a class="btn btn-success col-md-offset-4 col-md-4 col-sm-12 col-xs-12 btnfix" href="{{url('/donations/create')}}">Doniraj</a>
    <a class="btn btn-default col-md-offset-4 col-md-4 col-sm-12 col-xs-12 btnfix" href="{{url('/subscribe')}}">Budi aktivan</a>
  </div>
</div>
...
<div class="part">
  <div class="container">
      <div class="row">
        <div class="al-c col-md-6 col-sm-12" style="text-align:right;">
        ...
        <div class="al-c col-md-6 col-sm-12">
...
<div class="part">
  <div class="container">
      <div class="row">
        <div class="al-c col-md-5 col-sm-12">
          <img src="{{ url('img/mockup.png')}}" style="width:100%;" />
        </div>
        <div class="al-c col-md-7 col-sm-12" style="margin-bottom:30px;">
